...
import com.ss.editor.tonedog.emitter.control.model.property.control.particle.influencer.interpolation.control.AbstractInterpolationInfluencerControl;
...
public class Vector3fInterpolationElement<P extends InterpolatedParticleInfluencer, C extends AbstractInterpolationInfluencerControl<P>>
     ...
     */
    @FxThread
    protected @NotNull Vector3f getValue(@NotNull final P influencer) {
